...
public class PlayerController : MonoBehaviour
{
    ...
    // Singleton para LifeSystem (acceso externo)
    ...
    void Move()
    {
        ...
        Vector3 move = dir * speed; move.y = verticalVelocity;
        ...
        if (animator != null)
        {
            ...
            animator.SetBool("IsRunning", sprint && mag > 0.1f);
    ...
    void TryGrab()
    {
        ...
        GrabbableObject closest = null; float minDist = grabRange;
    ...
    SocketZone GetNearestSocket()
    {
        ...
        SocketZone nearest = null; float minDist = 2.5f;
    ...
    IEnumerator DamageRoutine()
    {
        ...
        {
            float t = 0f;
            while (t < 0.3f) { t += Time.deltaTime; damageOverlay.color = new Color(1, 0, 0, Mathf.Lerp(0.45f, 0f, t / 0.3f)); yield return null; }
    ...
    IEnumerator ShakeCamera()
    {
        ...
        {
            e += Time.deltaTime;
            if (cameraHolder != null) cameraHolder.localPosition = camOriginalPos + Random.insideUnitSphere * shakeIntensity;
            yield return null;
        }
    ...
    // Propiedad pública para SocketProximityDetector (ahora integrado aquí)
